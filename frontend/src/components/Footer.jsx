...
export class Footer extends Component {
  render() {
    ...
    <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div class="container flex flex-col flex-wrap px-10 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
            <div class="flex flex-col flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left left-48 md:w-96 md:pl-16">
                ...
                <div class="mt-4">
                    <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                        <Link class="text-gray-500 cursor-pointer hover:text-gray-700">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                class="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </Link>
                        <Link class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                class="w-5 h-5" viewBox="0 0 24 24">
                                <path
            ...
            <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Company</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Careers</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Blog</Link>
                        </li>
                    </nav>
                </div>
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Contact Support</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Help Resources</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Release Updates</Link>
                        </li>
                    </nav>
                </div>
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Terms &amp; Privacy</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Pricing</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">FAQ</Link>
                        </li>
                    </nav>
                </div>
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Send a Message</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">Request a Quote</Link>
                        </li>
                        <li class="mt-3">
                            <Link class="text-gray-500 cursor-pointer hover:text-gray-900">07 0771 1771</Link>
                        </li>
                    </nav>
                </div>
            </div>
